...
.icon-btn { background: none; border: none; color: var(--ink-soft); cursor: pointer; padding: 5px; border-radius: 4px; display: inline-flex; }
...
.check-inline { display: flex; align-items: center; gap: 6px; font-size: .83rem; }
...
.opt-btn { border: 1px solid var(--line); background: #fff; border-radius: 6px; padding: 7px 13px; font-size: .82rem; cursor: pointer; color: var(--ink-soft); }
